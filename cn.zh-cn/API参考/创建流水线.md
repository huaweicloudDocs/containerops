...
<td class="cellrowborder" valign="top" width="51.93519351935193%" headers="mcps1.2.5.1.4 "><p id="p9925151720398"><a name="p9925151720398"></a><a name="p9925151720398"></a>流水线执行的前置操作，详情请参见<a href="创建流水线.md#table147241715103913">表21</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.93519351935193%" headers="mcps1.2.5.1.4 "><p id="p1092591723911"><a name="p1092591723911"></a><a name="p1092591723911"></a>流水线全局变量，详情请参见<a href="#table125201315113919">表4</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.93519351935193%" headers="mcps1.2.5.1.4 "><p id="p169251217163912"><a name="p169251217163912"></a><a name="p169251217163912"></a>流水线的执行步骤，详情请参见<a href="#table5532121516391">表5</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.650000000000006%" headers="mcps1.2.5.1.4 "><p id="p1592818176397"><a name="p1592818176397"></a><a name="p1592818176397"></a>执行步骤的异常处理方式，详情请参见<a href="#table0367325987">表6</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.650000000000006%" headers="mcps1.2.5.1.4 "><p id="p99281917163918"><a name="p99281917163918"></a><a name="p99281917163918"></a>执行步骤的输入资源，详情请参见<a href="#table86670158394">表17</a>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.650000000000006%" headers="mcps1.2.5.1.4 "><p id="p1792813177390"><a name="p1792813177390"></a><a name="p1792813177390"></a>执行步骤的输出资源，详情请参见<a href="#table86670158394">表17</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.650000000000006%" headers="mcps1.2.5.1.4 "><p id="p17929161712393"><a name="p17929161712393"></a><a name="p17929161712393"></a>执行步骤的前置操作，详情请参见<a href="#table147241715103913">表21</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.650000000000006%" headers="mcps1.2.5.1.4 "><p id="p3929171711398"><a name="p3929171711398"></a><a name="p3929171711398"></a>执行步骤的后置操作，详情请参见<a href="#table1673216153395">表22</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="51.650000000000006%" headers="mcps1.2.5.1.4 "><p id="p2092919178393"><a name="p2092919178393"></a><a name="p2092919178393"></a>步骤的配置信息，有service_name相关，详情请参见<a href="#table356341563919">表8</a>，<a href="#table1258317155399">表10</a>，<a href="#table1060814150393">表12</a>，<a href="#table16171815143913">表13</a>，<a href="#table1164041523918">表15</a>，<a href="#table106542015113916">表16</a>。</p>
</td>
</tr>
</tbody>
</table>

**表 6**  exception\_handler参数说明
...
<td class="cellrowborder" valign="top" width="51.76482351764824%" headers="mcps1.2.5.1.4 "><p id="p10626336883"><a name="p10626336883"></a><a name="p10626336883"></a>异常处理的配置信息，timeout_reset类型需填写params，详情请参见<a href="#table1530144813132">表7</a>。</p>
</td>
</tr>
</tbody>
</table>

**表 7**  timeout\_reset exception\_handler的params参数说明
...
**表 8**  code\_source stage的params参数说明
...
<td class="cellrowborder" valign="top" width="51.76482351764824%" headers="mcps1.2.5.1.4 "><p id="p9948110112819"><a name="p9948110112819"></a><a name="p9948110112819"></a>触发器类型，详情请参见<a href="#table86851221162916">表9</a>。</p>
</td>
</tr>
</tbody>
</table>

**表 9**  code\_trigger参数说明
...
**表 10**  jenkins\_build stage的params参数说明
...
<td class="cellrowborder" valign="top" width="51.76482351764824%" headers="mcps1.2.5.1.4 "><p id="p1593113178398"><a name="p1593113178398"></a><a name="p1593113178398"></a>当basic_env为SelfPkgBuild提供，详情请参见<a href="#table65951159399">表11</a>。</p>
</td>
</tr>
...
**表 12**  dockerfile\_build stage的params参数说明
...
**表 13**  test\_review stage的params参数说明
...
<td class="cellrowborder" valign="top" width="49.63503649635037%" headers="mcps1.2.5.1.4 "><p id="p1194016176397"><a name="p1194016176397"></a><a name="p1194016176397"></a>审核的用户信息，详情请参见<a href="#table136291215203916">表14</a>。</p>
</td>
</tr>
</tbody>
</table>
...
**表 15**  official\_deploy stage的params参数说明
...
**表 16**  gray\_deploy stage的params参数说明
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.2.5.1.4 "><p id="p1794611763920"><a name="p1794611763920"></a><a name="p1794611763920"></a>资源的配置信息，与type字段有关。详情请参见<a href="#table12680615203917">表18</a>，<a href="#table2069271511396">表19</a>，<a href="#table187081115183914">表20</a>。</p>
</td>
</tr>
</tbody>
</table>

**表 18**  code\_source Resource的params参数说明
...
**表 19**  image Resource的params参数说明
...
**表 20**  package Resource的params参数说明
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.2.5.1.4 "><p id="p195421710393"><a name="p195421710393"></a><a name="p195421710393"></a>触发方式，详情请参见<a href="#table16744161516392">表23</a>。</p>
</td>
</tr>
</tbody>
</table>

**表 22**  PostOperation参数说明
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.2.5.1.4 "><p id="p1795610178396"><a name="p1795610178396"></a><a name="p1795610178396"></a>触发方式，详情请参见<a href="#table16744161516392">表23</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.2.5.1.4 "><p id="p1295731743917"><a name="p1295731743917"></a><a name="p1295731743917"></a>Webhook触发类型，详情请参见<a href="#table12757515143912">表24</a>。用于pre_operation的webhook时，pre_operation返回的webhook中会有生成的url地址，可调用该url触发流水线和执行步骤；用于post_operation的webhook时，须填写url具体内容。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.2.5.1.4 "><p id="p2957817133912"><a name="p2957817133912"></a><a name="p2957817133912"></a>Channel触发方式，详情请参见<a href="#table1769181543910">表25</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.2.5.1.4 "><p id="p13957201710396"><a name="p13957201710396"></a><a name="p13957201710396"></a>触发参数，详情请参见<a href="#table14774215153910">表26</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="57.52%" headers="mcps1.2.4.1.3 "><p id="p5964417103919"><a name="p5964417103919"></a><a name="p5964417103919"></a>流水线执行的前置操作，<span>详情</span>请参见<a href="创建流水线.md#table147241715103913">表21</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.52%" headers="mcps1.2.4.1.3 "><p id="p5964181711397"><a name="p5964181711397"></a><a name="p5964181711397"></a>流水线全局变量，<span>详情</span>请参见<a href="创建流水线.md#table125201315113919">表4</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.52%" headers="mcps1.2.4.1.3 "><p id="p19964191719393"><a name="p19964191719393"></a><a name="p19964191719393"></a>流水线的执行步骤，<span>详情</span>请参见<a href="#table1582417151391">表28</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="56.96%" headers="mcps1.2.4.1.3 "><p id="p496581773916"><a name="p496581773916"></a><a name="p496581773916"></a><span>详情</span>请参见<a href="创建流水线.md#table5532121516391">表5</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.96%" headers="mcps1.2.4.1.3 "><p id="p18965151712393"><a name="p18965151712393"></a><a name="p18965151712393"></a><span>详情</span>请参见<a href="创建流水线.md#table5532121516391">表5</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.96%" headers="mcps1.2.4.1.3 "><p id="p296610175395"><a name="p296610175395"></a><a name="p296610175395"></a><span>详情</span>请参见<a href="创建流水线.md#table5532121516391">表5</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.96%" headers="mcps1.2.4.1.3 "><p id="p1096661715390"><a name="p1096661715390"></a><a name="p1096661715390"></a><span>详情</span>请参见<a href="创建流水线.md#table5532121516391">表5</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.96%" headers="mcps1.2.4.1.3 "><p id="p396619179390"><a name="p396619179390"></a><a name="p396619179390"></a><span>详情</span>请参见<a href="#table147241715103913">表21</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.96%" headers="mcps1.2.4.1.3 "><p id="p896715173391"><a name="p896715173391"></a><a name="p896715173391"></a><span>详情</span>请参见<a href="#table1673216153395">表22</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.96%" headers="mcps1.2.4.1.3 "><p id="p119671517163911"><a name="p119671517163911"></a><a name="p119671517163911"></a><span>详情</span>请参见<a href="创建流水线.md#table5532121516391">表5</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.96%" headers="mcps1.2.4.1.3 "><p id="p29674174394"><a name="p29674174394"></a><a name="p29674174394"></a><span>详情</span>请参见<a href="创建流水线.md#table5532121516391">表5</a>。</p>
</td>
</tr>
</tbody>
</table>
